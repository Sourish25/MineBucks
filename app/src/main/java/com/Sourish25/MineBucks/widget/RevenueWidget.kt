    ...
    private fun RevenueWidgetContent() {
        ...
        androidx.glance.layout.Box(
            modifier = GlanceModifier
                ...
                .cornerRadius(24.dp)
                .clickable(androidx.glance.action.actionStartActivity<com.Sourish25.MineBucks.MainActivity>()),
            contentAlignment = Alignment.Center
        ) {
            // Background Faded Block
            androidx.glance.Image(
                provider = androidx.glance.ImageProvider(com.Sourish25.MineBucks.R.drawable.ic_faded_block),
        ...
        suspend fun updateRevenueWidget(context: Context, total: Double, currency: String) {
            ...
            glanceIds.forEach { glanceId ->
                androidx.glance.appwidget.state.updateAppWidgetState(context, glanceId) { prefs ->
                    prefs[com.Sourish25.MineBucks.widget.RevenueWidgetReceiver.TOTAL_REVENUE_KEY] = total
                    prefs[com.Sourish25.MineBucks.widget.RevenueWidgetReceiver.CURRENCY_KEY] = currency
                }
