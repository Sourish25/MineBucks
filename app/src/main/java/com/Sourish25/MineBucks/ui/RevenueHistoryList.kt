...
fun RevenueHistoryList(
    ...
    Column(modifier = modifier) {
        if (history.isEmpty()) {
            Text(androidx.compose.ui.res.stringResource(com.Sourish25.MineBucks.R.string.no_recent_activity), style = MaterialTheme.typography.bodyMedium)
        } else {
...
fun HistoryItem(daily: DailyRevenue, currency: String) {
    ...
    Row(
        ...
        Column {
            ...
            Text(
                text = androidx.compose.ui.res.stringResource(com.Sourish25.MineBucks.R.string.daily_total),
